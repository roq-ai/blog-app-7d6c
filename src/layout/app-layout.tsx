...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['blog-owner', 'blog-writer', 'blog-editor'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Blog', path: '/blogs', entity: 'blog', service: AccessServiceEnum.PROJECT, icon: FiFileText },
    {
      name: 'Blog Category',
    ...
    { name: 'Category', path: '/categories', entity: 'category', service: AccessServiceEnum.PROJECT, icon: FiBookmark },
    {
